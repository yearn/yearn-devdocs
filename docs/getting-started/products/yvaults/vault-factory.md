...
Anyone can call harvest via the harvest() function on the keeper found at [keeper.factory.ychad.eth](https://etherscan.io/address/0x0d26e894c2371ab6d20d99a65e991775e3b5cad7#writeContract). Simply put in the strategy address from the factory vault which you would like to call harvest on, and click write.
