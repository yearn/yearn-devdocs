...
- Peg Stability: Checking exchange rates for [LSTs/LRTs](https://github.com/yearn/monitoring/tree/main/protocols/lrt-pegs) (like stETH, ezETH, pufETH, rsETH) and stablecoins (USDe, USDS, USD0) in key liquidity pools, alerting on significant depegs.
