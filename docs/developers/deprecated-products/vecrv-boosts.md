...
> **This page is outdated since yveCRV was deprecated in favour of yCRV. Check the new yCRV [page](/getting-started/products/ycrv/overview).**
...
Some strategies also implement [flash loans](/resources/defi-glossary#flash-loan), which is typically a backend service that requires development experience to take advantage of.
