...
1. Create a new issue in the strategies' [private repo](https://github.com/iearn-finance/yearn-strategies/issues) using the template `Strategy Review`. **Complete all the fields**.
...
1. Coordinate with Core Dev strategist for getting a review on [private board](https://github.com/orgs/yearn/projects/5).
...
1. Tag GitHub review issue with deployed version and add mainnet address(es) to the [private board](https://github.com/orgs/yearn/projects/5).
