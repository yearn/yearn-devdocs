...
- **Limits rent-seeking benefits.** The design avoids holders being rewarded for nothing and letting the largest holders accumulate more at the expense of the smaller holders.
...
dYFI (previously known as oYFI) is a token introduced as part of Yearn's veYFI tokenomics program. It is an ERC-20 token that allows its holder to buy back YFI at a discount. 
