...
Yearn V2 Partner Tracker was made to accurately track the amount of traffic generated by a partner, so that they can be compensated accordingly. This contract makes use of the `VaultAPI` contract to track and manage deposits.
